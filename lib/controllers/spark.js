...
exports.show = function (req, res, next) {
  var getListings = function() {
    ...
    var options = {
        ...
        headers: {'Authorization': 'OAuth ' + req.user.spark.accessToken, "X-SparkApi-User-Agent": "SparkAPIExamples", "Accept": '*/*', 'User-Agent': 'curl/7.30.0'}
    };
...
var refreshCheck = function(expireDate, callback, refreshToken, userID) {
  ...
  var refreshCallback = function(response) {
    ...
    response.on('end', function() {
      ...
      var updatedObject = {
        spark: {
          refreshToken: parsedResponse.refresh_token || "cswqlq25xngtths1jugyd13s0", 
          accessToken: parsedResponse.access_token || "byq2yv47qoyz7gorknep94n2w",
