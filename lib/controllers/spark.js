...
// curl "https://sparkapi.com/v1/oauth2/grant" -H "X-SparkApi-User-Agent: SparkAPIExamples" -H "Authorization: OAuth MY_OAUTH2_ACCESS_TOKEN" {} -H 'Content-Type: application/json' -X POST --data '{"client_id": "2784vbb6k8i7ejdy0vkd0r8ll","client_secret":  "1r116sle8q7dnwsmbjxykilu2","grant_type": "authorization_code","code": "cpj5725mcb3jn1balrcgjp2yp", "redirect_uri": "https://post-office-project.herokuapp.com"}'
...
exports.show = function (req, res, next) {
  var getListings = function(sparkObject) {
    if(sparkObject) {
      req.user.spark = sparkObject;
    };
    ...
    var options = {
        ...
        headers: {'Authorization': 'OAuth ' + req.user.spark.accessToken, "X-SparkApi-User-Agent": "SparkAPIExamples-Node", "Accept": '*/*', 'User-Agent': 'curl/7.30.0'}
    };
...
exports.get = function (req, res, next) {
  ...
  refreshCheck(req.user.spark.expireDate, getListing, req.user.spark.refreshToken, req.user._id);
}
...
var refreshCheck = function(expireDate, callback, refreshToken, userID) {
  ...
  if(expireDate && (expireDate.getTime() < currentDate.getTime())) {
    //curl "https://sparkapi.com/v1/oauth2/grant" -H "X-SparkApi-User-Agent: SparkAPIExamples" -H "Authorization: OAuth MY_OAUTH2_ACCESS_TOKEN" {} -H 'Content-Type: application/json' -X POST --data '{"client_id": "2784vbb6k8i7ejdy0vkd0r8ll","client_secret":  "1r116sle8q7dnwsmbjxykilu2","grant_type": "refresh_token","refresh_token": "9cbbxpdubqix9v5usii6svpb3", "redirect_uri": "https://post-office-project.herokuapp.com"}'
    var post_data = {
  ...
  var refreshCallback = function(response) {
    ...
    response.on('end', function() {
      ...
      if(parsedResponse.refresh_token && parsedResponse.access_token){
